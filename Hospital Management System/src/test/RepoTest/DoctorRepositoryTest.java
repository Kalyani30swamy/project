...
public class DoctorRepositoryTest {
	...
	void testSaveDOCTOR() 
	{
		Doctor D = new Doctor(1,"Kalyani Swamy",1056,"Pune","Cardiology",150);
	...
	void testGetAllDoctor() 
	{
		List<Doctor>Doctor=Stream
				.of(new Doctor(1,"Kalyani Swamy",1056,"Pune","Cardiology",150),
			new Doctor(1,"Kalyani Swamy",1056,"Pune","Cardiology",150))
