...
public class PatientRepositoryTest {
	...
	{
		Patient P = new Patient(1,"Rajendra Thorat",108,"Pune","Lung Infecton");
	...
	void testGetAllPatient() 
	{
		List<Patient>Patient=Stream
				.of(new Patient(1,"Rajendra Thorat",108,"Pune","Lung Infecton"),
			new Patient(1,"Rajendra Thorat",108,"Pune","Lung Infecton"))
